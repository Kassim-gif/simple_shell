...
/**
 * help_alias - Displays infor on tha shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Display infor on tha shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Display infor on tha shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on thee shellby builtin command 'help'.
 */
void help_help(void)
{
