...
/**
 * error_env - Creat  error message for shellby_env errors.
 * @args:Array of argument passed to tha command.
 *
...
/**
 * error_1 - Creats  errr mssge for shellby_alias errors.
 * @args: An array of arguments passed to tha command.
 *
 * Return: The error string.
 */
char *error_1(char **args)
...
/**
 * error_2_exit - Creates an errr messge for shellby_exit errors.
